...
public class JavaOnlyMap implements ReadableMap, WritableMap {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C10862 {
    ...
    public static JavaOnlyMap deepClone(ReadableMap readableMap) {
        ...
        while (keySetIterator.hasNextKey()) {
            ...
            switch (C10862.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                case 1:
    ...
    /* renamed from: of */
    public static JavaOnlyMap m5161of(Object... objArr) {
