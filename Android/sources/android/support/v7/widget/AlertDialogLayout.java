...
public class AlertDialogLayout extends C0416Q {
    ...
    /* renamed from: b */
    private void m2143b(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private static int m2144c(View view) {
        int m520h = C0107v.m520h(view);
        if (m520h > 0) {
            return m520h;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m2144c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: e */
    private void m2145e(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0416Q.a aVar = (C0416Q.a) childAt.getLayoutParams();
    ...
    /* renamed from: f */
    private boolean m2146f(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0117f.topPanel) {
                    view = childAt;
                } else if (id == C0117f.buttonPanel) {
                    view2 = childAt;
                } else {
                    if ((id != C0117f.contentPanel && id != C0117f.customPanel) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            android.support.v7.widget.Q$a r15 = (android.support.v7.widget.C0416Q.a) r15
            int r2 = r15.f2125b
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = p000a.p005b.p009c.p019h.C0107v.m518g(r17)
            int r2 = p000a.p005b.p009c.p019h.C0091f.m429a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L95
            r3 = 5
