...
public class C1526b extends AbstractC1330c<C1526b> {

    /* renamed from: f */
    private WritableMap f5648f;

    public C1526b(int i, WritableMap writableMap) {
        super(i);
        this.f5648f = writableMap;
    }

    @Override // com.facebook.react.uimanager.events.AbstractC1330c
    /* renamed from: a */
    public void mo5714a(RCTEventEmitter rCTEventEmitter) {
        rCTEventEmitter.receiveEvent(m5723g(), mo5715d(), this.f5648f);
    }
