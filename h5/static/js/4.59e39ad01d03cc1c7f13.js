webpackJsonp([4], {
    ...
    SHt1: function(e, t, n) {
        ...
        var i = n("ytdl"),
            a = n.n(i),
            o = n("lVAl"),
            r = (n("xrTZ").Base64, n("xrTZ").Base64),
            s = {
                props: ["eposide", "animate", "sort"],
                filters: {
                    titlefer1: function(e) {
                        if (e.split(" ").length > 0) return e.split(" ")[0]
                    },
                    titlefer2: function(e) {
                        if (e.split(" ").length > 0) return e.split(" ")[1]
                    }
                },
                methods: {
                    playTo: function(e, t) {
                ...
                mounted: function() {
                    this.$refs.eposideScroll.scrollLeft = 16 * (this.sort - 1) * 9
                }
            },
            l = {
                render: function() {
                    ...
                    }, [n("span", [e._v("选集")]), e._v(" "), n("span", [e._v("全 " + e._s(e.eposide.length) + " 话")])]), e._v(" "), n("div", {
                        ref: "eposideScroll",
                        staticClass: "eposide-con"
                    }, [n("div", {
                        staticClass: "eposide-scroll",
                        style: {
                            width: 9 * e.eposide.length + .6 + "rem"
                        }
                    }, e._l(e.eposide, function(t, i) {
                        return n("div", {
                            key: i,
                            staticClass: "eposide-list",
                            class: e.sort == i + 1 ? "active" : "",
                            on: {
                                click: function(n) {
                                    return e.playTo(e.animate, t.baseinfo_episode_sort)
                                }
                            }
                        }, [n("span", [e._v(e._s(e._f("titlefer1")(t.baseinfo_episode_title)))]), e._v(" "), n("span", [e._v(e._s(e._f("titlefer2")(t.baseinfo_episode_title)))])])
                    }), 0)])])
                },
                staticRenderFns: []
            };
        var c = n("VU/8")(s, l, !1, function(e) {
                n("pb0P")
            }, "data-v-6221abc8", null).exports,
            u = n("cJ47"),
            d = (n("9hJ1"), n("wU2u")),
            p = n.n(d),
            h = {
                props: ["type", "link", "dplayerid", "danmu"],
                data: function() {
                    return {}
                },
                watch: {
                ...
                methods: {
                    dplayer: function() {
                        n && n.destroy();
                        var e = this.$store.state.config.img.dplayer,
                            t = {
                                ...
                                danmaku: {
                                    id: this.dplayerid,
                                    api: this.$store.state.config.imgurl,
                                    token: "tokendemo",
                                    maximum: 1e3,
                                    addition: [this.$store.state.config.imgurl + "/bilibili?aid=" + this.danmu],
                                    user: "qinmei",
                                    bottom: "15%",
                                    unlimited: !0
                                },
                                contextmenu: [{
                                    text: "主题地址",
                                    link: "https://github.com/JsaRut/ainPress"
                                }]
                            },
                            n = new p.a(t)
                    }
            ...
            f = {
                render: function() {
                    ...
                    return t("div", {
                        ...
                        ref: "player",
                        staticClass: "play-con"
                    }, ["true" !== this.type ? [t("iframe", {
                        attrs: {
                            src: this.link,
                            id: "iframe-play"
                        }
        ...
        var m = n("VU/8")(h, f, !1, function(e) {
                n("dV9z")
            }, "data-v-0cb7def4", null).exports,
            y = n("/kga"),
            v = (y.a, Boolean, Boolean, String, String, Boolean, String, String, String, String, Number, String, String, String, Boolean, Object, Boolean, String, Boolean, Boolean, {
                name: "confirm",
                components: {
                    XDialog: y.a
                },
                    ...
                    return n("div", {
                        ...
                        on: {
                            ...
                            change: function(t) {
                                ...
                                if (Array.isArray(n)) {
                                    var o = e._i(n, null);
                                    i.checked ? o < 0 && (e.msg = n.concat([null])) : o > -1 && (e.msg = n.slice(0, o).concat(n.slice(o + 1)))
                                } else e.msg = a
                            }
                        }
        ...
        var b = n("VU/8")(v, g, !1, function(e) {
                n("av+/")
            }, null, null).exports,
            w = (n("xrTZ").Base64, o.a, n("xrTZ").Base64),
            k = {
                components: {
                    Comment: o.a,
                    Eposide: c,
                ...
                methods: {
                    initData: function() {
                        var e = this;
                        this.$Spin.show();
                        var t = w.decode(this.$route.query.l).split(";?;");
                        this.id = t[0], 0 == t[1] ? this.sort = 1 : this.sort = t[1], Object(u.a)({
                            method: "post",
                            url: "/animeinfo/play",
                            data: {
                                animate: this.id,
                            ...
                            t.data && (e.playinfo = t.data, e.$Spin.hide(), "404" == t.data.link && e.$Notice.warning({
                                title: "对不起，你没有权限播放此视频",
                                duration: 0
                            }))
                        })
                    },
                    initView: function() {
                        ...
                        Object(u.a)({
                            ...
                            t.data && (e.playinfo.count = t.data)
                        })
                    },
                    animatereport: function() {
                        var e = this;
                        if (this.report.content.length < 10) this.$Notice.error({
                            title: "请输入字符数大于10"
                        });
                        else {
                            var t = a()(localStorage.token).data.user.id,
                                n = new Date;
                            Object(u.a)({
                                method: "post",
                                url: "/users/" + t,
                    ...
                    saveHistory: function() {
                        var e = a()(localStorage.token).data.user.id,
                            t = new Date;
                        Object(u.a)({
                            method: "post",
                            url: "/users/" + e,
                ...
                mounted: function() {
                    this.initData(), this.initView(), setTimeout(this.saveHistory, 3e5)
                },
                beforeRouteUpdate: function(e, t, n) {
                    n(), this.initData(), this.initView(), setTimeout(this.saveHistory, 3e5)
                }
            },
            _ = {
                render: function() {
                    ...
                    return n("div", {
                    ...
                    }, [e.playinfo.setting ? n("div", {
                        staticClass: "play-main"
                    }, [n("Play", {
                        attrs: {
                            type: e.playinfo.setting,
                            link: e.playinfo.link,
                            dplayerid: e.playinfo.dplayer,
                            danmu: e.playinfo.danmu
                        }
                    })], 1) : e._e(), e._v(" "), n("div", {
                        staticClass: "ainfo-eposide"
                    }, [e.playinfo.eposide ? n("Eposide", {
                        attrs: {
                            sort: e.sort,
                            eposide: e.playinfo.eposide,
                            animate: e.id
                        }
                    }) : e._e()], 1), e._v(" "), n("div", {
                        staticClass: "animate-info"
                    }, [n("div", {
                        staticClass: "ainfo-cover",
                        style: {
                            backgroundImage: "url(" + e.playinfo.img + ")"
                        },
                        on: {
                            click: function(t) {
                                return e.goTo(e.playinfo.slug)
                            }
                        }
                    }), e._v(" "), n("div", {
                        staticClass: "ainfo-main"
                    }, [n("div", {
                        staticClass: "ainfo-name",
                        on: {
                            click: function(t) {
                                return e.goTo(e.playinfo.slug)
                            }
                        }
                    }, [n("span", [e._v(e._s(e.playinfo.name))])]), e._v(" "), n("div", {
                        staticClass: "ainfo-icon"
                    }, [n("div", {
                        staticClass: "ainfo-icon-list"
                    }, [n("i", {
                        staticClass: "iconfont icon-youtube"
                    }), e._v(" "), n("span", [e._v(e._s(e.playinfo.count))])]), e._v(" "), n("div", {
                        staticClass: "ainfo-icon-list"
                    }, [n("i", {
                        staticClass: "iconfont icon-star"
                    }), e._v(" "), n("span", [e._v(e._s(e.playinfo.star))])]), e._v(" "), n("div", {
                        staticClass: "ainfo-icon-list ainfo-icon-list-report",
                        on: {
                            click: e.videoReport
                        }
                    }, [n("i", {
                        staticClass: "iconfont icon-jubao"
                    }), e._v(" "), n("span", [e._v("问题反馈")])])]), e._v(" "), n("div", {
                        staticClass: "ainfo-desc"
                    }, [e._v("\n          " + e._s(e.playinfo.desc) + "\n        ")])])]), e._v(" "), e.id ? n("div", {
                    ...
                    })], 1) : e._e(), e._v(" "), n("confirm", {
                        attrs: {
                            title: "请提交具体反馈信息"
                        },
                        on: {
                            "on-confirm": e.animatereport
                        },
                        model: {
                            value: e.report.show,
                            callback: function(t) {
                                e.$set(e.report, "show", t)
                            },
                            expression: "report.show"
                        }
                    }, [n("textarea", {
                        directives: [{
                            name: "model",
                            rawName: "v-model",
                            value: e.report.content,
                            expression: "report.content"
                        }],
                        ...
                        on: {
                            input: function(t) {
                                t.target.composing || e.$set(e.report, "content", t.target.value)
                            }
                        }
                    })])], 1)
                },
        ...
        var x = n("VU/8")(k, _, !1, function(e) {
            n("qa/2")
        }, "data-v-1df3b092", null);
        t.default = x.exports
    },
    "av+/": function(e, t) {},
    dV9z: function(e, t) {},
        ...
        window, i = function() {
            return function(e) {
                    ...
                    r = function() {
                        function e(t) {
                            ...
                            if (this.player.danmaku) {
                                ...
                                var r = function(e) {
                                        var t = e || window.event,
                                            i = ((t.clientX || t.changedTouches[0].clientX) - o.default.getBoundingClientRectViewLeft(n.player.template.danmakuOpacityBarWrap)) / 130;
                                        i = Math.max(i, 0), i = Math.min(i, 1), n.player.danmaku.opacity(i)
                                    },
                                    s = function e() {
                                        document.removeEventListener(o.default.nameMap.dragEnd, e), document.removeEventListener(o.default.nameMap.dragMove, r), n.player.template.danmakuOpacityBox.classList.remove("dplayer-setting-danmaku-active")
                                    };
                                this.player.template.danmakuOpacityBarWrapWrap.addEventListener("click", function(e) {
                                    ...
                                    document.addEventListener(o.default.nameMap.dragMove, r), document.addEventListener(o.default.nameMap.dragEnd, s), n.player.template.danmakuOpacityBox.classList.add("dplayer-setting-danmaku-active")
                                })
                            }
                        }
                        return a(e, [{
                    ...
                    r = function() {
                        function e(t) {
                            ...
                            var i = function() {
                                ...
                                a = function() {
                                    ...
                                    e && e !== n.player.container || (n.player.resize(), e ? n.player.events.trigger("fullscreen") : (o.default.setScrollPosition(n.lastScrollPosition), n.player.events.trigger("fullscreen_cancel")))
                                };
                        ...
                        return a(e, [{
                            ...
                            value: function() {
                                ...
                                switch (n || (this.lastScrollPosition = o.default.getScrollPosition()), e) {
                                    case "browser":
                ...
                var i, a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
                    ...
                    s = function() {
                        ...
                        return o(e, [{
                            ...
                            value: function() {
                                var e, t = this;
                                e = this.options.api.maximum ? this.options.api.address + "v3/?id=" + this.options.api.id + "&max=" + this.options.api.maximum : this.options.api.address + "v3/?id=" + this.options.api.id;
                            ...
                            value: function(e) {
                                ...
                                if (this.showing) {
                                        ...
                                        u = function(e, n, o) {
                                            for (var r = i / c(o), u = function(a) {
                                                    ...
                                                    for (var u = 0; u < o.length; u++) {
                                                        var d = l(o[u]) - 10;
                                                        if (d <= i - r * c(parseInt(o[u].style.width)) || d <= 0) break;
                                    ...
                                    for (var d = document.createDocumentFragment(), p = function(a) {
                                            e[a].type = r.default.number2Type(e[a].type), e[a].color || (e[a].color = 16777215);
                                            var o = document.createElement("div");
                                            o.classList.add("dplayer-danmaku-item"), o.classList.add("dplayer-danmaku-" + e[a].type), e[a].border ? o.innerHTML = '<span style="border:' + e[a].border + '">' + e[a].text + "</span>" : o.innerHTML = e[a].text, o.style.opacity = t._opacity, o.style.color = r.default.number2Color(e[a].color), o.addEventListener("animationend", function() {
                                            ...
                                            switch (e[a].type) {
                                                case "right":
                                                    (l = u(o, e[a].type, s)) >= 0 && (o.style.width = s + 1 + "px", o.style.top = n * l + "px", o.style.transform = "translateX(-" + i + "px)");
                                                    break;
                                                case "top":
                ...
                i.prototype = new Error, i.prototype.code = 5, i.prototype.name = "InvalidCharacterError", e.exports = function(e) {
                    for (var t, n, a = String(e), o = "", r = 0, s = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="; a.charAt(0 | r) || (s = "=", r % 1); o += s.charAt(63 & t >> 8 - r % 1 * 8)) {
                        if ((n = a.charCodeAt(r += .75)) > 255) throw new i;
                        t = t << 8 | n
                    }
                    return o
                }
                ...
                var i, a = (i = n(67)) && i.__esModule ? i : {
                    default: i
                };
                t.default = {
                    send: function(e) {
                        a.default.post(e.url, e.data).then(function(t) {
                            var n = t.data;
                    ...
                    read: function(e) {
                        a.default.get(e.url).then(function(t) {
                            var n = t.data;
                ...
                (function(e) {
                    ...
                    l.prototype.catch = function(e) {
                    ...
                    }, l.prototype.finally = o.default, l.all = function(e) {
                        ...
                        return e && "object" === (void 0 === e ? "undefined" : a(e)) && e.constructor === l ? e : new l(function(t) {
                            t(e)
                        })
                    }, l.reject = function(e) {
                        return new l(function(t, n) {
                    ...
                    L = function() {
                        function e(t) {
                            ...
                            ! function(e, t) {
                                ...
                                index: C,
                                tran: this.tran
                            }), this.video = this.template.video, this.bar = new m.default(this.template), this.bezel = new v.default(this.template.bezel), this.fullScreen = new p.default(this), this.controller = new g.default(this), this.options.danmaku && (this.danmaku = new u.default({
                                ...
                                n.focus = !0
                            }, !0), this.paused = !0, this.timer = new y.default(this), this.hotkey = new k.default(this), this.contextmenu = new _.default(this), this.initVideo(this.video, this.quality && this.quality.type || this.options.video.type), this.infoPanel = new x.default(this), !this.danmaku && this.options.autoplay && this.play(), C++, E.push(this)
                        }
                        return i(e, [{
                            key: "seek",
                            value: function(e) {
                            ...
                            value: function() {
                                ...
                                if (this.paused = !1, this.video.paused && this.bezel.switch(c.default.play), this.template.playButton.innerHTML = c.default.pause, a.default.resolve(this.video.play()).catch(function() {
                                    ...
                                    for (var t = 0; t < E.length; t++) this !== E[t] && E[t].pause()
                            }
                        }, {
                            key: "pause",
                            value: function() {
                            ...
                            key: "destroy",
                            value: function() {
                                E.splice(E.indexOf(this), 1), this.pause(), this.controller.destroy(), this.timer.destroy(), this.video.src = "", this.container.innerHTML = "", this.events.trigger("destroy")
                            }
                        }], [{
                            key: "version",
                            get: function() {
                ...
                var b64chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
                    ...
                    cb_decode = function(e) {
                        var t = e.length,
                            ...
                            a = [fromCharCode(i >>> 16), fromCharCode(i >>> 8 & 255), fromCharCode(255 & i)];
