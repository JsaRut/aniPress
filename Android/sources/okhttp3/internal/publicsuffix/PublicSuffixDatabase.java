...
public final class PublicSuffixDatabase {
    ...
    private void readTheList() {
        ...
        InterfaceC2721i m11745a = C2732t.m11745a(new C2726n(C2732t.m11742a(resourceAsStream)));
        try {
            byte[] bArr = new byte[m11745a.readInt()];
            m11745a.readFully(bArr);
            byte[] bArr2 = new byte[m11745a.readInt()];
            m11745a.readFully(bArr2);
            synchronized (this) {
