...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private InterfaceC2720h sink;
    private Socket socket;
    private InterfaceC2721i source;
    ...
    /* loaded from: classes.dex */
    public class C27701 extends RealWebSocket.Streams {
        final /* synthetic */ StreamAllocation val$streamAllocation;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C27701(boolean z, InterfaceC2721i interfaceC2721i, InterfaceC2720h interfaceC2720h, StreamAllocation streamAllocation) {
            super(z, interfaceC2721i, interfaceC2720h);
            r5 = streamAllocation;
        }

        @Override // java.io.Closeable, java.lang.AutoCloseable
        public void close() {
            StreamAllocation streamAllocation = r5;
    ...
    private void connectSocket(int i, int i2, Call call, EventListener eventListener) {
        ...
        try {
            ...
            try {
                this.source = C2732t.m11745a(C2732t.m11748b(this.rawSocket));
                this.sink = C2732t.m11744a(C2732t.m11741a(this.rawSocket));
            ...
            try {
                ...
                try {
                    ...
                    if (address.hostnameVerifier().verify(address.url().host(), session)) {
                        ...
                        this.source = C2732t.m11745a(C2732t.m11748b(this.socket));
                        this.sink = C2732t.m11744a(C2732t.m11741a(this.socket));
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) {
        ...
        while (true) {
            ...
            InterfaceC2709D newFixedLengthSource = http1Codec.newFixedLengthSource(contentLength);
            Util.skipAll(newFixedLengthSource, Integer.MAX_VALUE, TimeUnit.MILLISECONDS);
            newFixedLengthSource.close();
            int code = build.code();
            if (code == 200) {
                if (this.source.mo11674a().mo11695d() && this.sink.mo11674a().mo11695d()) {
                    return null;
                }
    ...
    */
    ...
    public RealWebSocket.Streams newWebSocketStreams(StreamAllocation streamAllocation) {
        return new RealWebSocket.Streams(true, this.source, this.sink) { // from class: okhttp3.internal.connection.RealConnection.1
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C27701(boolean z, InterfaceC2721i interfaceC2721i, InterfaceC2720h interfaceC2720h, StreamAllocation streamAllocation2) {
                super(z, interfaceC2721i, interfaceC2720h);
            ...
            @Override // java.io.Closeable, java.lang.AutoCloseable
            public void close() {
                StreamAllocation streamAllocation2 = r5;
