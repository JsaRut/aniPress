webpackJsonp([5], {
	...
	SHt1: function(e, t, n) {
		...
		var i = n("ytdl"),
			...
			s = {
				render: function() {
					...
					}, e._l(e.eposide, function(t) {
						return n("div", {
							staticClass: "eposide-list",
							class: t.baseinfo_episode_sort == e.sort ? "active" : "",
							on: {
								click: function(n) {
									return e.playTo(e.animate, t.baseinfo_episode_sort)
								}
							}
						}, [n("span", [e._v(e._s(e._f("titlefer")(t.baseinfo_episode_title)) + "\n          ")])])
					}), 0)])
				},
				staticRenderFns: []
			};
		var l = n("VU/8")(r, s, !1, function(e) {
				n("5Syy")
			}, "data-v-7f276fda", null).exports,
			c = n("lVAl"),
			u = n("cJ47"),
			d = (n("9hJ1"), n("wU2u")),
			p = n.n(d),
			h = (n("xrTZ").Base64, c.a, n("xrTZ").Base64),
			f = {
				components: {
					EposideList: l,
					Comment: c.a
				...
				methods: {
					initData: function() {
						var e = this,
							t = h.decode(this.$route.query.l).split(";?;");
						this.id = t[0], this.sort = t[1], Object(u.a)({
							method: "post",
							url: "/animeinfo/play",
							data: {
								animate: this.id,
							...
							e.$Spin.hide(), t.data && (e.playinfo = t.data, "404" == t.data.link ? e.$Notice.warning({
								title: "对不起，你没有权限播放此视频",
								duration: 0
							}) : "true" == t.data.setting && e.dplayer())
						})
					},
					initView: function() {
						var e = this;
					...
					reportok: function() {
						"" !== this.report.content && this.animatereport()
					},
					reportform: function() {
						this.auth() || (this.report.show = !0)
					},
					animatereport: function() {
						var e = this,
							t = a()(localStorage.token).data.user.id,
							n = new Date;
						Object(u.a)({
							method: "post",
							url: "/users/" + t,
					...
					dplayer: function() {
						...
						var e = this.$store.state.config.img.dplayer,
							t = {
								...
								mutex: !0,
								video: {
									url: this.playinfo.link,
									pic: e,
									type: "auto"
								},
								danmaku: {
									id: this.playinfo.dplayer,
									api: this.$store.state.config.imgurl,
									token: "tokendemo",
									maximum: 1e3,
									addition: [this.$store.state.config.imgurl + "bilibili?aid=" + this.playinfo.danmu],
									user: "qinmei",
									bottom: "15%",
									unlimited: !0
								},
								contextmenu: [{
									text: "主题地址",
									link: "https://github.com/qinvz/qinpress"
								}]
							},
							n = new p.a(t)
					},
					...
					resizewin: function() {
						this.height = this.$refs.player.offsetWidth / 1920 * 1080
					}
				},
				mounted: function() {
					this.$Spin.show(), this.initData(), this.initView(), this.resizewin(), setTimeout(this.saveHistory, 3e5), window.addEventListener("resize", this.resizewin)
				},
				beforeDestroy: function() {
					window.removeEventListener("resize", this.resizewin)
				},
				beforeRouteUpdate: function(e, t, n) {
					n(), this.initData(), this.initView(), this.resizewin(), setTimeout(this.saveHistory, 3e5)
				}
			},
			m = {
				render: function() {
					...
					return n("div", {
					...
					}, ["true" !== e.playinfo.setting ? [n("iframe", {
						style: {
							height: e.height + "px"
						},
						attrs: {
						...
						class: 0 == e.sideindex ? "header-title active" : "header-title",
						on: {
							click: function(t) {
								e.sideindex = 0
							}
						}
					}, [n("span", [e._v("选集")])]), e._v(" "), n("div", {
						class: 1 == e.sideindex ? "header-title active" : "header-title",
						on: {
							click: function(t) {
								e.sideindex = 1
							}
						}
					}, [n("span", [e._v("弹幕")])])]), e._v(" "), n("div", {
						staticClass: "sidebar-con"
					}, [n("div", {
						directives: [{
							name: "show",
							rawName: "v-show",
							value: 0 == e.sideindex,
							expression: "sideindex == 0"
						}],
						staticClass: "sidecon-panel"
					}, [e.playinfo.eposide ? n("EposideList", {
						attrs: {
							sort: e.sort,
						...
						directives: [{
							...
							rawName: "v-show",
							value: 1 == e.sideindex,
							expression: "sideindex == 1"
						}],
						staticClass: "sidecon-panel"
					})])])]), e._v(" "), e.playinfo.eposide ? n("div", {
						staticClass: "container-main"
					}, [n("div", {
						staticClass: "con-main-left"
					}, [n("div", {
						staticClass: "panel margin-bottom"
					}, [n("div", {
						staticClass: "play-icon"
					}, [n("div", {
						staticClass: "play-name"
					}, [e._v("\n                " + e._s(e.playinfo.name) + " - " + e._s(e.playinfo.title) + "\n                "), n("Icon", {
						attrs: {
							type: "logo-youtube"
						}
					}), e._v(" "), n("span", [e._v(e._s(e.playinfo.count))])], 1), e._v(" "), n("div", {
					...
					}, [n("span", [e._v(e._s(e.playinfo.desc))])])])]), e._v(" "), n("Modal", {
						on: {
							"on-ok": e.reportok
						},
						model: {
						...
						staticClass: "modelinfo"
					}, [e._v("请填写详细的问题描述以便及时解决问题")]), e._v(" "), n("Input", {
		...
		var y = n("VU/8")(f, m, !1, function(e) {
			n("oIp6")
		}, "data-v-323179c8", null);
		t.default = y.exports
	},
	oIp6: function(e, t) {},
	wU2u: function(e, t, n) {
					...
					C = function() {
						function e(t) {
							...
							! function(e, t) {
								...
								n.focus = !0
							}, !0), this.paused = !0, this.timer = new y.default(this), this.hotkey = new k.default(this), this.contextmenu = new x.default(this), this.initVideo(this.video, this.quality && this.quality.type || this.options.video.type), this.infoPanel = new _.default(this), !this.danmaku && this.options.autoplay && this.play(), E++, L.push(this)
						}
						return i(e, [{
							key: "seek",
							value: function(e) {
							...
							value: function() {
								...
								if (this.paused = !1, this.video.paused && this.bezel.switch(c.default.play), this.template.playButton.innerHTML = c.default.pause, a.default.resolve(this.video.play()).catch(function() {
									...
									for (var t = 0; t < L.length; t++) this !== L[t] && L[t].pause()
							}
						}, {
							key: "pause",
							value: function() {
							...
							key: "destroy",
							value: function() {
								L.splice(L.indexOf(this), 1), this.pause(), this.controller.destroy(), this.timer.destroy(), this.video.src = "", this.container.innerHTML = "", this.events.trigger("destroy")
							}
						}], [{
							key: "version",
							get: function() {
