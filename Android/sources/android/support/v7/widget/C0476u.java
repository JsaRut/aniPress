...
public class C0476u extends MultiAutoCompleteTextView implements InterfaceC0105t {

    /* renamed from: a */
    private static final int[] f2503a = {R.attr.popupBackground};

    /* renamed from: b */
    private final C0454j f2504b;

    /* renamed from: c */
    private final C0403H f2505c;

    public C0476u(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0112a.autoCompleteTextViewStyle);
    }

    public C0476u(Context context, AttributeSet attributeSet, int i) {
        super(C0473sa.m2564a(context), attributeSet, i);
        C0479va m2571a = C0479va.m2571a(getContext(), attributeSet, f2503a, i, 0);
        if (m2571a.m2589g(0)) {
            setDropDownBackgroundDrawable(m2571a.m2579b(0));
        }
        m2571a.m2576a();
        this.f2504b = new C0454j(this);
        this.f2504b.m2470a(attributeSet, i);
        this.f2505c = new C0403H(this);
        this.f2505c.m2211a(attributeSet, i);
        this.f2505c.m2206a();
    }
    ...
    protected void drawableStateChanged() {
        ...
        C0454j c0454j = this.f2504b;
        if (c0454j != null) {
            c0454j.m2465a();
        }
        C0403H c0403h = this.f2505c;
        if (c0403h != null) {
            c0403h.m2206a();
        }
    }
