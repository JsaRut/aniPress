...
public final class WebSocketProtocol {
    ...
    public static String acceptHeader(String str) {
        return C2722j.m11725c(str + ACCEPT_MAGIC).mo11653f().mo11649b();
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void toggleMask(C2719g.a aVar, byte[] bArr) {
        int length = bArr.length;
        int i = 0;
        do {
            byte[] bArr2 = aVar.f11395e;
            int i2 = aVar.f11396f;
            int i3 = aVar.f11397g;
            while (i2 < i3) {
                int i4 = i % length;
