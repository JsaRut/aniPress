...
public class C0482x extends RadioButton implements InterfaceC0275E {

    /* renamed from: a */
    private final C0462n f2516a;

    /* renamed from: b */
    private final C0403H f2517b;

    public C0482x(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0112a.radioButtonStyle);
    }

    public C0482x(Context context, AttributeSet attributeSet, int i) {
        super(C0473sa.m2564a(context), attributeSet, i);
        this.f2516a = new C0462n(this);
        this.f2516a.m2478a(attributeSet, i);
        this.f2517b = new C0403H(this);
        this.f2517b.m2211a(attributeSet, i);
    }

    @Override // android.widget.CompoundButton, android.widget.TextView
    public int getCompoundPaddingLeft() {
        int compoundPaddingLeft = super.getCompoundPaddingLeft();
        C0462n c0462n = this.f2516a;
